...
public class UserMessage implements Serializable {
	...
	private UserMessageExtendDto getExtendDto() {
		return StringTools.isEmpty(extendJson) ? null : JsonUtils.covertJson2Obj(extendJson, UserMessageExtendDto.class);
	}

	private void setExtendDto(UserMessageExtendDto extendDto) {
