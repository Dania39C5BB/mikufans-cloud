...
public interface UserVideoSeriesService {
    ...
    void saveVideoSeries(UserVideoSeries userVideoSeries, String videoIds);

	void saveVideoInSeries(Integer seriesId, String userId ,  String videoIds);

	List<UserVideoSeries> getUserVideoSeriesCover(String userId);

	void deleteSeriesInVideo(Integer seriesId, String userId, String videoId);

	void changeVideoSeriesSort(String seriesIds, String userId);

	List<UserVideoSeries> findUserHomeVideoSeries(UserVideoSeriesQuery userVideoSeriesQuery);
}