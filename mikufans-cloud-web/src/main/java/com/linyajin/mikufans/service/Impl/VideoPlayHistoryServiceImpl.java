...
public class VideoPlayHistoryServiceImpl implements VideoPlayHistoryService {
	 ...
	 */
	@Override
	public VideoPlayHistory getVideoPlayHistoryByUserId(String userId) {
		return this.videoPlayHistoryMapper.selectByUserId(userId);
	}
	 ...
	 */
	@Override
	public Integer updateVideoPlayHistoryByUserId(VideoPlayHistory bean, String userId) {
		return this.videoPlayHistoryMapper.updateByUserId(bean, userId);
	}
