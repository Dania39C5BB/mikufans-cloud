...
public interface StatisticsInfoService {
	...
	Map<String , Integer> selectAllStatisticsInfo(String userId);

	List<StatisticsInfo> findTotalStatisticsInfo(StatisticsInfoQuery statisticsInfoQuery);

	List<StatisticsInfo> findUserCountByParam(StatisticsInfoQuery statisticsInfoQuery);
}